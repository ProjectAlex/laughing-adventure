...
ActiveRecord::Schema.define(version: 20140411084412) do
  ...
  create_table "dislikers", id: false, force: true do |t|
    t.integer "user_id"
    t.integer "post_id"
  end

  add_index "dislikers", ["user_id", "post_id"], name: "index_dislikers_on_user_id_and_post_id"
  ...
  create_table "likers", id: false, force: true do |t|
    t.integer "user_id"
    t.integer "post_id"
  end
